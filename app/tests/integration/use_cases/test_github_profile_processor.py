...
def test_valid_return_group_user_data(
    valid_username, github_personal_access_token_, github_client, git_profile_dumper_to_file
):
...
def test_create_file_name(valid_username, github_personal_access_token_, github_client, git_profile_dumper_to_file, grouped_user_data):
...
def test_correct_user_data_dump_file(valid_username, github_personal_access_token_, github_client, git_profile_dumper_to_file, grouped_user_data, filtered_data):
