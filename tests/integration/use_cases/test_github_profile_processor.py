...
def test_valid_return_group_user_data(data_grouped, valid_username_id, valid_username):
    ...
    assert repository_name in [repository['name']
                               for repository in data_grouped[1]]
